...
window = tk.Tk()
window.title("Calculator - Rossieyboyyy")
...
button_multypl = tk.Button(master= frame, text = "*", padx= 15, pady= 5, width=3, command=lambda : myclick("*" )) 
button_multypl.grid(row=5, column=2,pady=2)   

button_div = tk.Button(master= frame, text = "/", padx= 15, pady= 5, width=3, command=lambda : myclick("/" )) 
button_div.grid(row=6, column=0,pady=2)   

button_Clear = tk.Button(master= frame, text = "Clear", padx= 15, pady= 5, width=5, command= clear) 
button_Clear.grid(row=6, column=2,pady=2)   

button_equal = tk.Button(master= frame, text = "Enter", padx= 15, pady= 5, width=3, command= equal ) 
button_equal.grid(row=8, column=0,pady=2)  
window.mainloop() 